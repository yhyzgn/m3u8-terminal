...
// SetDefaultKey Set encryption key appeared once in header of the playlist (pointer to MediaPlaylist.Key).
...
// SetDefaultMap Set map appeared once in header of the playlist (pointer to MediaPlaylist.Key).
...
// SetIframeOnly Mark medialist as consists of only I-frames (Intra frames).
// Set tag for the whole list.
...
// SetDiscontinuity Set discontinuity flag for the current media segment.
...
// SetProgramDateTime Set program date and time for the current media segment.
